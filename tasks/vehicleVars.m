...
Vehicle.Rotor.controlModePosVSOrient = 5.5; % Lift slope
Vehicle.Rotor.area = pi*Vehicle.Rotor.radius^2;
Vehicle.Rotor.lock = rho*Vehicle.Rotor.controlModePosVSOrient*Vehicle.Rotor.chord*Vehicle.Rotor.radius^4/...
